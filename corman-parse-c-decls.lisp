...
(defpackage :lisp-windows/corman-c-decls
  (:use :common-lisp)
  (:export :transcribe-file))

(in-package :lisp-windows/corman-c-decls)
...
(defun translate-typedef-scalar (tokens)
  (multiple-value-bind (new-type-name type-def-form)
    ...
    `(defctype ,new-type-name ,type-def-form)))
  ...
  (let ((*package* (find-package package)))
	...
	(format out
		";;; ~A -- Automatically generated FFI definition file.~@
                 ...
                 ;;; Transcribed: "
		out-file in-file)
	(format-universal-time (get-universal-time) out)
